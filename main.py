...
class VkUser:
    ...
    def photos_get(self, count=None):
        ...
        print(f'Информация из Vk запрошена успешно')
    ...
    def conv_dict_list(self, information_dict):
        ...
        print(f'Информация отконвертирована в список')
    ...
    def create_json(self, name=None):
        ...
        print(f'Создан файл с информацией по сохранённым фотографиям')
        return info_list
...
admin = YaUser('<Your Yandex Disk token>')
